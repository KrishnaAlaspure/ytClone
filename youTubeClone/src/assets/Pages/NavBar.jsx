  ...
  return (
    <div className=" sticky top-0 flex items-center justify-between my-2 bg-white">
      <div className="flex items-center justify-around gap-4 ">
        <GiHamburgerMenu onClick={toggleHandler} className="hover:cursor-pointer" size={28} />
        <img
          src={YouTubeLogo}
          className="w-"
          width={"120px"}
      ...
      <div className="flex w-[40%] items-center justify-between">
        <div className="flex w-[1000%] border border-gray-600 rounded-full justify-between mr-2">
          ...
          <button onClick={handleClickEvent}><FiSearch className="items-center" size={20}  /> </button>
          </div>
        </div>
      ...
      <div className="flex justify-between items-center  ">
        ...
        <Avatar src="https://discourse.disneyheroesgame.com/uploads/default/original/3X/0/8/08607f6fb4891b7f2917930419bed6f45c665df3.jpeg" size={40} round={true} className="mx-2"/>
      </div>
    </div>
  );
}
